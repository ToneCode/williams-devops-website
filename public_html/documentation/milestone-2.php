...
<html lang="en">
	...
	<body>
		...
		<p>Site will consist of 3 top-level pages total. No sub-pages or sub-navigation. This will be the Minimum Value Product.</p>
		<ul>
			<li>Home Page</li>
			<li>About Me</li>
			<li>Contact</li>
		...
		<p>Matthew is viewing the site on his desktop computer at the office, with a 27" screen, using Safari. He has 29 other tabs open. From LinkedIn, he links to my personal website which opens in a new window. In the next 3 minutes, here is an outline of Matthew's interactions with my site: </p>
		<ol>
			<li>Lands on Home page. Views a "quote where I describe my work flow" Clicks call to action that navigates to the About Me page.</li>
			<li>Views my core skills featured in a contrasting side panel.  Finds my professional history to be outstanding.  The interaction stops there.  Matthew has decided, based on the information provided, that I will be included in the preliminary phone screens.  He does not need to navigate away, because my contact info is visible in the footer.  Matthew leaves the About Me page open for reference during the preliminary phone call.</li>
		</ol>
		<h3>WireFrames</h3>
		...
		<img src="images/content-page-desktop.svg" alt="Desktop WireFrame"
		<br>		  
