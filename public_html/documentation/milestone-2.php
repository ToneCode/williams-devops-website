...
<html lang="en">
	...
	<body>
		...
		<ol>
			...
			<li>Views my core skills featured in a contrasting side panel.  Finds my professional history to be outstanding.  The interaction stops there.  David has decided, based on the information provide, that I will be included in the preliminary phone screens.  He does not need to navigate away, because my contact info is visible in the footer.  David leaves the About Me page open for reference during the prelimary phone call.</li>
		</ol>
		<h3>WireFrames</h3>
